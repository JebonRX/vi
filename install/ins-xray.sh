...
wget -O port-trojan "https://raw.githubusercontent.com/${GitUser}/vi/adata/change-port/port-trojan.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/vi/adata/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/vi/adata/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/vi/adata/menu/xraay.sh"
wget -O trafficxray "https://raw.githubusercontent.com/${GitUser}/vi/adata/trafficxray.sh"
chmod +x port-xray
chmod +x port-trojan
chmod +x certv2ray
chmod +x trojaan
