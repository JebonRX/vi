...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/${GitUser}/vi/adata/add-user/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/${GitUser}/vi/adata/delete-user/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/${GitUser}/vi/adata/cek-user/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/${GitUser}/vi/adata/renew-user/renew-ss.sh"
wget -O ssssr "https://raw.githubusercontent.com/${GitUser}/vi/adata/menu/ssssr.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
